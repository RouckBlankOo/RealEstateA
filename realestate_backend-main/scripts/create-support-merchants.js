/**
 * Direct MongoDB insert for support account into Merchants collection
 */
...
async function insertAccount() {
    ...
    try {
        ...
        const merchants = db.collection('merchants'); // Changed from 'users' to 'merchants'

        // Check if exists
        const existing = await merchants.findOne({ email: 'support@realestate.com' });
